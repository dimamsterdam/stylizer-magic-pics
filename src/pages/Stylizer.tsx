  ...
  return <div className="h-full w-full pt-4">
      {isPickingProducts ? <div className="p-4 sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <Card className="border-0 shadow-sm">
              <CardHeader className="p-6">
                <h2 className="text-xl font-semibold text-[#1A1F2C] py-0">Define the fashion model</h2>
                <p className="text-[#6D7175] py-0">Describe your ideal model by clicking on any attribute to customize it</p>
              </CardHeader>
              <CardContent className="p-6 pt-0">
